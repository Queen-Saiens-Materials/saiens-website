      ...
      <div className="mx-auto max-w-5xl">
        <div className="flex flex-col items-center gap-6 text-center sm:flex-row sm:items-start sm:gap-10 sm:text-left">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm leading-relaxed text-(--dark-accent)">
              GREENGUARD: All Caesarstone quartz surfaces comply with
              GREENGUARD certification, verifying that Caesarstone products
              meet the most stringent indoor air emission standards.
            </p>
            <p className="text-sm leading-relaxed text-(--dark-accent)">
              ...
              &amp; Schools Certification), which evaluates the sensitive
              nature of school populations combined with the unique building
              characteristics found in schools, and presents the most
              rigorous product emissions criteria to date.
            </p>
          </div>
        </div>
        ...
        <div className="mt-16 flex flex-col items-center gap-6 text-center sm:flex-row sm:items-start sm:gap-10 sm:text-left">
          ...
          <div className="flex flex-col gap-4">
            ...
            <p className="text-sm leading-relaxed text-(--dark-accent)">
              As a global leader in independent certification and
              verification of environmental and sustainable stewardship, SCS
              Global Services has developed internationally recognized
              standards and certification programs to achieve the highest
              environmental performance and social accountability level.
            </p>
            <p className="text-sm leading-relaxed text-(--dark-accent)">
              Some Caesarstone models are SCS-certified for recycled content,
              made with up to 50% pre-consumer recycled crushed glass
              content.
            </p>
            <p className="text-sm leading-relaxed text-(--dark-accent)">
